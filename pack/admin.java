...
public class admin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        acpass = new javax.swing.JPasswordField();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

        jPanel1.setBackground(new java.awt.Color(237, 246, 249));

        adminsignup.setBackground(new java.awt.Color(0, 102, 102));
        adminsignup.setFont(new java.awt.Font("Century Gothic", 0, 14)); // NOI18N
        ...
        jLabel6.setText("Set up password");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(adminsignup, javax.swing.GroupLayout.PREFERRED_SIZE, 196, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(171, 171, 171))
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(aname)
                    .addComponent(amobile)
                    .addComponent(amail)
                    .addComponent(apass)
                    .addComponent(acpass, javax.swing.GroupLayout.DEFAULT_SIZE, 228, Short.MAX_VALUE))
                .addGap(74, 74, 74))
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(34, 34, 34)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGap(22, 22, 22)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(amobile, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGap(28, 28, 28)
                .addComponent(adminsignup, javax.swing.GroupLayout.PREFERRED_SIZE, 48, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(31, 31, 31))
        );
    ...
    private void adminsignupActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_adminsignupActionPerformed
        ...
        try{
            ...
            int mob = Integer.parseInt(amob);
            String mail = amail.getText();

            String pwd = apass.getText();
            String con = acpass.getText();
                if(!"".equals(pwd) | !"".equals(con)){
                    if(pwd.equals( con)){
                        String pass = passwordHash(pwd);
                        ob.adsignup(an, mob, mail, pass);
    ...
    private javax.swing.JPasswordField acpass;
